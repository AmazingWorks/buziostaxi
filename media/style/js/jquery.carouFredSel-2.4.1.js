...
(function($) {
	$.fn.carouFredSel = function(o) {
		...
		this.init = function(o) {
			...
			if (typeof(opts.items.start)				!= 'number')	opts.items.start				= 0;
		...
		this.bind_events = function() {
			$cfs
				...
				.bind('prev', function(e, sO, nI) {
					...
					a_cfs[opts.dimentions[4]] = opts.padding[3];
					...
					$cfs.data('cfs_numItems', nI)
						...
						.animate(a_cfs, {
							...
							complete: function() {
								...
								$cfs.css(opts.dimentions[4], opts.padding[3]);
	...
	function mapWrapperSizes(ws, o) {
		var wra = {};
			wra[o.dimentions[0]] = ws[0] + o.padding[1] + o.padding[3];
			wra[o.dimentions[2]] = ws[1] + o.padding[0] + o.padding[2];
		return wra;
	};
	function setSizes($c, o) {
		...
		$c.css(o.dimentions[0], is[0]*2)
			.css(o.dimentions[2], is[1])
			.css(o.dimentions[5], o.padding[0])
			.css(o.dimentions[4], o.padding[3]);
	};
